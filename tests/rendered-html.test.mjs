...
test("keeps the restored interactions in the client surface", async () => {
  ...
  for (const feature of [
    ...
    "数据统计生效周期",
    "按日期展示 A、B 两组全部指标",
    "AB测试明细_${dateRange.startDate.replaceAll",
    "AB测试明细_${hourlyDate.replaceAll",
    "分时明细日期",
    "label: \"DAU\"",
    "对比涨幅",
    "查看 A/B 分组对比",
    ...
    "保存实验",
    "saveRunningTestName",
    "requestRunningTrafficSave",
    "确认调整流量比例",
    "pendingExperimentStart",
    "确认开启实验",
    "saveRunningConfig",
    "实验流量比例已调整",
    "实验已保存，状态为待开启",
    ...
    "确认停用",
    "停用后，该流量分组策略将立即失效",
    "pendingExperimentAllocation",
    "confirmExperimentAllocation",
    "流量全量切换",
    "组配置进行推全",
    "已将分组流量全部配置给${pendingExperimentAllocation}组",
